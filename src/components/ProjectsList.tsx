...
const Project: React.FC<ProjectProps> = ({ projects }) => {
    ...
    return (
        <div
          ...
          m-4 rounded-[10px] text-white font-bold shadow-md hover:scale-105 duration-500 mb-8">
            ...
            <div className="tech-stack  flex flex-wrap row-span-2 justify-around items-center ">
                {projects.techs.map((item) => (
                    <div
                        key={item}
                        className="text-sm md:text-xl rounded-md p-2">
                        {item}
                    </div>
                ))}
            </div>
            <div className="font-bold row-span-2 grid grid-cols-2">
                <div className="flex flex-col justify-center items-center gap-2 text-2xl">
                    <a
                        className="bg-white text-green-500 h-12 w-24 p-2 m-2 rounded-full animate-pulse"
                    ...
                    <a
                        className="btn h-16 w-24 m-2 p-1 rounded-2xl"
