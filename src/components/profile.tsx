...
function Profile() {
  return (
    <div className='mt-2'>
        <a href="https://git.io/typing-svg"><img src="https://readme-typing-svg.demolab.com?font=Fira+Code&weight=800&size=35&duration=2500&pause=700&color=0ACF11&vCenter=true&width=600&height=75&lines=Hey...;I'm+James;Kilonzo+James." alt="Typing SVG" /></a>
        <div className='flex flex-wrap justify-center'>
            <h3 className='text-green-400 text-4xl my-6'>Fullstack Web Developer</h3>
            <br/>
