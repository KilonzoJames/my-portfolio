...
function Contacts() {
  return (
    <div className="flex flex-col gap-12">
      ...
      <div className="text-gradient text-xl mx-[4vw] p-[2vw]">
        I'm always open to connecting with others. Whether you have questions,
        suggestions, or just want to say hello, feel free to reach out! I'm also
        open to collaborating on projects, so if you have an idea in mind, don't
      ...
      <div className="grid lg:grid-cols-3 place-items-center gap-16">
        {divs.map((div, index) => (
          <div
            className="contact grid grid-row-3 w-60 h-72 shadow-md shadow-orange-500"
            key={index}
          >
